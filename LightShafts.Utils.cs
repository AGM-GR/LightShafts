...
public partial class LightShafts : MonoBehaviour {
    private static readonly int CameraPosLocal = Shader.PropertyToID("_CameraPosLocal");
    private static readonly int FrustumRays = Shader.PropertyToID("_FrustumRays");
    private static readonly int FrustumApex = Shader.PropertyToID("_FrustumApex");
    ...
    void SetFrustumRays(Material material) {
        ...
        material.SetVector(CameraPosLocal, cameraPosLocal);
        material.SetMatrix(FrustumRays, frustumRays);
        material.SetFloat(FrustumApex, GetFrustumApex());
    }
